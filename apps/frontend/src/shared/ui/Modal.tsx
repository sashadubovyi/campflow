...
export function Modal({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-neutral-900/40 backdrop-blur-sm"
      onClick={closeOnBackdrop ? onClose : undefined}
    >
      <div
        className={cn('w-full bg-white rounded-card-lg shadow-card-lg', sizes[size])}
